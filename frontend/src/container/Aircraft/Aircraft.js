          ...
          return (
            <TabPanel value={value} index={index} key={`aircraft${index}`}>
              <Box className="panel-header-details">
                ...
                <Typography variant="h6">{`Numéro de la queue :${obj.description.tailNumber}`}</Typography>
                <Typography variant="h6">{`Société: ${wordCapitalization(
                  obj.owner[obj.owner.length - 1].company
                )}`}</Typography>
                <Typography variant="h6">{`Heures de vol: ${obj.flightHours}`}</Typography>
                <HistoryTable
                  objArray={obj.owner}
                  mapping={{
                    company: "Entreprise",
              ...
              <Box my={1} className="panel-content">
                <Typography variant="h5">Contrôles de maintenance</Typography>
                <Box pt={1}>
                  {obj.maintenanceSchedule.map(maintenance => {
                    return (
                      <ProgressBar
                        ...
                        label={`${maintenance.type} Vérification - Dernière exécution : ${
              ...
              <Box my={1} className="panel-content">
                <Typography variant="h5">pièces Provenance </Typography>
                <Box pt={1}>
              ...
              <Box my={1} className="panel-content">
                <Typography variant="h5">Rapports d'entretien</Typography>
